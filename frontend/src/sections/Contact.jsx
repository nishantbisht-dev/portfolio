...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Removes ending slash from VITE_API_URL if you added it by mistake
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`mt-2 px-6 py-3 rounded-full text-sm transition flex items-center justify-center gap-2 ${
                loading
                  ? "bg-gray-400 text-white cursor-not-allowed"
                  : "bg-black text-white hover:opacity-90 dark:bg-white dark:text-black"
              }`}
            ...
            {error && (
              <div className="rounded-2xl border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950/30 px-4 py-3">
